...
lines = (
    lines[0:(lines.index("// AUTOMATIC available_symFuns start\n")+1)] +
    lines[lines.index("// AUTOMATIC available_symFuns end\n")::])
lines = (
    lines[0:(lines.index("// AUTOMATIC get_TwoBodySymFuns start\n")+1)] +
    lines[lines.index("// AUTOMATIC get_TwoBodySymFuns end\n")::])
lines = (
    lines[0:(lines.index("// AUTOMATIC get_ThreeBodySymFuns start\n")+1)] +
